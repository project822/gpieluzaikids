...
// `recentDays` hari terakhir (aturan 5 hari) — data LAMA tetap utuh di
// database (tidak dihapus), hanya disembunyikan dari daftar agar tidak
// menumpuk. `all: true` mengembalikan semuanya (dipakai export/riwayat).
export async function getAttendance({ recentDays = 5, all = false } = {}) {
