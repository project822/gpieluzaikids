...
export const CHURCH = {
  ...
  description:
    'GPI Eluzai hadir sebagai rumah ibadah dan persekutuan yang hangat bagi seluruh keluarga. Melalui ibadah, pengajaran Firman Tuhan, dan pelayanan, kami bertumbuh bersama dalam kasih Kristus.',
...
export const HOME_SLIDES = [
  {
    ...
    caption: 'Tempat jemaat beribadah dan bersekutu dalam kasih Kristus.',
  },
  {
    id: 'slide-ibadah',
    scene: 'worship',
    title: 'Suasana Ibadah',
    caption: 'Pujian dan penyembahan yang membawa hadirat Tuhan.',
  },
  {
    id: 'slide-persekutuan',
    scene: 'fellowship',
    title: 'Persekutuan Jemaat',
    caption: 'Kebersamaan keluarga yang saling menguatkan dan mendoakan.',
  },
];
...
export const DEMO_BANNERS = [
  {
    ...
    caption: 'Marilah kita beribadah dan memuliakan nama-Nya bersama.',
...
export const DEMO_EVENTS = [
  {
    ...
    description:
      'Kebaktian kebangunan rohani bersama jemaat: pujian, penyembahan, dan Firman yang menguatkan iman. Terbuka untuk seluruh keluarga.',
    active: true,
  },
  {
    id: 'evt-festival',
    ...
    description:
      'Malam pujian dan penyembahan yang dipersembahkan oleh tim pujian dan seluruh jemaat. Datang dan rasakan hadirat Tuhan.',
    active: true,
  },
  {
    id: 'evt-retret',
    ...
    description:
      'Tiga hari teduh di alam: renungan pagi, sesi penggembalaan, dan kebersamaan jemaat. Kuota terbatas.',
    active: true,
  },
  {
    id: 'evt-natal',
    ...
    description:
      'Perayaan Natal bersama: drama, pujian, dan pesan Natal untuk seluruh keluarga jemaat.',
    active: true,
  },
];
